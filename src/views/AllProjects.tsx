...
const allProjects = [
  ...
  },
  {
    ...
    description: 'A sleek and dynamic Music Player Website built with JavaScript! Enjoy a vibrant neon-themed interface where you can play your favorite songs seamlessly.',
    tags: ['HTML', 'CSS', 'JavaScript'],
    liveUrl: 'https://Itz-Murali.github.io/Music-Player',
    sourceUrl: 'https://Github.com/Itz-Murali/Music-Player',
    isPrivate: false,
    image: 'https://files.catbox.moe/xeb0tr.png',
  },
  {
    title: 'Image Generator Website',
    description: 'A powerful and creative tool built with JavaScript! Generate stunning images effortlessly with just a click.',
    tags: ['HTML', 'CSS', 'JavaScript'],
